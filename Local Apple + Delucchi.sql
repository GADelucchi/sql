...
CREATE USER "super_usuario"@"localhost" IDENTIFIED BY "SuperUsuario";

CREATE USER "solo_lectura"@"localhost" IDENTIFIED BY "SoloLectura";
...
GRANT SELECT, INSERT, UPDATE, DELETE ON *.* TO "super_usuario"@"localhost";
